...
package com.android.systemui.arsenic.statusbarweather;
...
public class StatusBarWeatherImage extends ImageView implements
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUSBAR_SHOW_WEATHER_TEMP), false, this,
                    UserHandle.USER_ALL);
            updateSettings();
        }
    ...
    public void updateSettings() {
        ...
        mStatusBarWeatherEnabled = Settings.System.getIntForUser(
                resolver, Settings.System.STATUSBAR_SHOW_WEATHER_TEMP, 0,
