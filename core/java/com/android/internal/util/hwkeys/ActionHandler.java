...
public class ActionHandler {
    ...
    static SystemAction[] systemActions = new SystemAction[] {
            ...
            SystemAction.Assistant, SystemAction.GoogleAssistant,
...
*/
    ...
    public static void performTask(Context context, String action) {
        ...
        if (!action.startsWith(SYSTEM_PREFIX)) {
            ...
            StatusBarHelper.toggleCameraFlash();
            return;
...
*/
    ...
    public static void startAssistantSoundSearch(Context context) {
        // Shazam 
        if (ArsenicUtils.isPackageInstalled(context, "com.shazam.android") || ArsenicUtils.isPackageInstalled(context, "com.shazam.encore.android")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.shazam.android.intent.actions.START_TAGGING");
        	intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            context.startActivity(intent);
        // Soundhound
        } else if (ArsenicUtils.isPackageInstalled(context, "com.melodis.midomiMusicIdentifier.freemium") || ArsenicUtils.isPackageInstalled(context, "com.melodis.midomiMusicIdentifier")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.soundhound.android.ID_NOW_EXTERNAL");
        	intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            context.startActivity(intent);
        // Google Search Music
        } else if (ArsenicUtils.isPackageInstalled(context, "com.google.android.googlequicksearchbox")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
